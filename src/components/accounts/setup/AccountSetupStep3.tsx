...
export const AccountSetupStep3 = ({
  ...
  const forwardSectionRadius = "$8" as const;
  const forwardItemRadius = "$7" as const;
  const forwardChipRadius = "$6" as const;
  const forwardButtonRadius = "$8" as const;
  ...
  const getRuleId = (rule: any) => {
    const raw =
      rule?.rule?.id || rule?.id || rule?.ruleId || rule?.uuid || rule?.rule_id;
  ...
  const renderRulesSection = (title: string, note?: string) => (
    <YStack
      ...
      borderRadius={forwardItemRadius}
      borderWidth={1}
    ...
    >
      ...
      {!hasInstitution && (
        <Text fontSize="$2" color="$gray9">
          Tu cuenta no tiene institución definida. Edita la cuenta para asignar
          el banco y habilitar reglas.
        </Text>
      )}
      {accountInstitution ? (
        <Text fontSize="$2" color="$gray9">
          ...
          {rules.map((rule) => {
            ...
            return (
              <XStack
                ...
                padding="$3"
                borderRadius={forwardChipRadius}
              >
                ...
                <Button
                  ...
                  color="white"
                  borderRadius={forwardButtonRadius}
      ...
      {selectedMethod === AccountSetupMethod.EMAIL_HISTORY && (
        <YStack space="$4">
          ...
          >
            ...
            <Text fontSize="$3" color="$gray10">
              Importaremos movimientos de los ultimos 90 días.
            </Text>
          </YStack>
          <YStack
            space="$4"
      ...
      {selectedMethod === AccountSetupMethod.EMAIL_FORWARD && (
        <YStack space="$5">
          <YStack
            ...
            borderRadius={forwardSectionRadius}
            padding="$4"
            borderWidth={1}
            borderColor={forwardPalette.shellBorder}
          >
            <XStack alignItems="center" space="$3">
              <Circle size={40} backgroundColor={forwardPalette.stepAlias.soft}>
              ...
              <YStack flex={1}>
                ...
                <Text fontSize="$2" color={forwardPalette.muted}>
                  Configura Gmail en 5 pasos claros.
                </Text>
              </YStack>
              <XStack
                alignItems="center"
          ...
          >
            <XStack alignItems="center" space="$3">
              <Circle
                size={28}
                backgroundColor={forwardPalette.stepAlias.accent}
              >
            ...
            >
              ...
              <Button
                ...
                chromeless
                icon={
                  <Copy size={16} color={forwardPalette.stepAlias.accent} />
                }
                onPress={onCopyAlias}
              />
            </XStack>
          ...
          >
            <XStack alignItems="center" space="$3">
              <Circle
                size={28}
                backgroundColor={forwardPalette.stepConfirm.accent}
              >
                <Text color="white" fontWeight="800">
                  2
                </Text>
          ...
          >
            <XStack alignItems="center" space="$3">
              <Circle
                size={28}
                backgroundColor={forwardPalette.stepFilter.accent}
              >
                <Text color="white" fontWeight="800">
                  3
                </Text>
          ...
          >
            <XStack alignItems="center" space="$3">
              ...
              <YStack flex={1}>
                ...
                <Text fontSize="$2" color={forwardPalette.muted}>
                  Selecciona reglas para clasificar los correos reenviados.
                </Text>
              </YStack>
            </XStack>
            {renderRulesSection(
              "Reglas disponibles",
              "Estas reglas se aplican a la fuente de correo activa para clasificar correos.",
            )}
          </YStack>
          ...
          >
            <XStack alignItems="center" space="$3">
              <Circle
                size={28}
                backgroundColor={forwardPalette.stepVerify.accent}
              >
                <Text color="white" fontWeight="800">
                  5
                </Text>
